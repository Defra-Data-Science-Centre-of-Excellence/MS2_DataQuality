...
ui <- dashboardPage( 
  ...
  dashboardHeader(title = "Data Quality (DQ)"),
  ...
  fluidRow(
    ...
    fluidRow(
      width = 12,
      shiny::h3(strong("DQ Metrics at field level (Exportable) - Top 5 rows")),
    ...
    fluidRow(
      shiny::h3(strong("DQ Metrics associated with data set:")),
